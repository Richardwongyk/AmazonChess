...
#ifndef AMAZONS-LOCAL_PRIVATE_H
#define AMAZONS-LOCAL_PRIVATE_H
...
#define ORIGINAL_FILENAME	"Amazons-local.exe"
#define PRODUCT_NAME	"Amazons-local"
#define PRODUCT_VERSION	"0.1.1.1"

#endif /*AMAZONS-LOCAL_PRIVATE_H*/
